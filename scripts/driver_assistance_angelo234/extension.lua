...
local lane_centering_assist_system_on = true
...
local function toggleLaneCenteringAssistSystem()
  if not extra_utils.getPart("lane_assist_angelo234") then return end

  lane_centering_assist_system_on = not lane_centering_assist_system_on
  local state = lane_centering_assist_system_on and "ON" or "OFF"
    ...
    if other_systems_timer >= 1.0 / 120.0 then
      ...
      elseif phase == 1 then
        ...
        if extra_utils.getPart("acc_angelo234") and acc_system_on then
          ...
          if extra_utils.getPart("lane_assist_angelo234") and lane_centering_assist_system_on then
...
local function getLaneCenteringSensorData()
  return lane_centering_system.getSensorData()
end
...
M.toggleLaneCenteringAssistSystem = toggleLaneCenteringAssistSystem
M.toggleLaneAssistSystem = toggleLaneCenteringAssistSystem
...
M.getLaneCenteringSensorData = getLaneCenteringSensorData
M.getLaneSensorData = getLaneCenteringSensorData
